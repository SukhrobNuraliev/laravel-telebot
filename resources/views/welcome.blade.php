...
<div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
    ...
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
        ...
        <div>
            <h1>Bu o'zgardi</h1>
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusantium adipisci minus nesciunt
                perspiciatis, sapiente sit velit. Cupiditate eos eum ipsum labore libero, minima non praesentium
                repellat soluta vitae. Ipsa, necessitatibus!</p>
            <button>salom</button>
        </div>
                ...
                <div class="p-6 border-t border-gray-200 dark:border-gray-700 md:border-l">
                    ...
                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            ...
                            <a href="https://envoyer.io" class="underline">Envoyer</a> help you take your projects to
                            the next level. Pair them with powerful open source libraries like
